...
function timerContHandler() {
    timer = setInterval(function () {
        ...
        if (timeCount == 0) {
            clearInterval(timer)
            statusTime.style.background = 'rgb(53, 138, 250)'
            nextQuestion.classList.add('show-next')
...
function updateScore(right) {
    ...
    if (right > 6) {
        ...
        cupImage.setAttribute('src', 'https://i.giphy.com/media/rZmz2Mf309fG03Cng5/giphy.webp')
    } else if (right <= 4 && right >= 2) {
        cupImage.setAttribute('src', 'https://i.giphy.com/media/5F2QLyO87Nx3K905p1/giphy.webp')
